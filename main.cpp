...
string leerArduino(int fd) {
    ...
    while (true) {
        ...
        if (n > 0) {
            ...
            timeouts++;
            if (timeouts >= 3) { // Si pasan ~3 segundos sin línea completa
                return "";
            }
        } else {
...
int main() {
    ...
    while (opcion != 0) {
        ...
        char comando = 0;
        switch (opcion) {
            case 1: comando = 'M'; break;
            case 2: comando = 'V'; break;
            case 3: comando = 'A'; break;
            case 4: {
            ...
            case 0: cout << "Cerrando conexión..." << endl; break;
